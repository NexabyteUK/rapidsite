import { Section, Grid, FeatureCard } from '../ui'
...
const features = [
  {
    ...
    title: "Week Not Months",
    description: "While other agencies disappear for 6 weeks, we get you online in 7 days. Because your business can't wait."
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: "One fixed monthly fee covers absolutely everything. No hidden costs, no surprise bills, no drama."
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: "Sleep easy knowing your site's secure and always online. We handle the technical stuff so you don't have to worry."
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: "Your customers can find you whether they're on their phone, tablet, or computer. It just works."
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Actual people, based in the UK, who answer their emails. No chatbots, no waiting for days."
  }
]
